...
+ (NSString *)nowDateString {
    ...
    [res setDateFormat:@"yyyy-MM-dd"];
    [formatter setTimeZone:localTimeZone];
    [res setTimeZone:localTimeZone];
    NSString *dayStart =[formatter stringFromDate:date];
    dayStart = [dayStart substringToIndex:10];
    return dayStart;
}
...
+ (NSDate *)nowDate {
    ...
    NSString *dayStart =[formatter stringFromDate:date];
    dayStart = [dayStart substringToIndex:10];
    return [res dateFromString:dayStart];
}
...
+ (NSString *)getCurrentMonth {
    ...
    unsigned unitFlags =
    NSCalendarUnitYear  |
    NSCalendarUnitMonth |NSCalendarUnitDay | NSCalendarUnitHour| NSCalendarUnitMinute | NSCalendarUnitSecond | NSCalendarUnitWeekday;
    //获取不同时间字段的信息
